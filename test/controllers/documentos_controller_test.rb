...
class DocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documento" do
    assert_difference("Documento.count") do
      post documentos_url, params: { documento: { contenido: @documento.contenido, descripcion: @documento.descripcion } }
    end
  ...
  test "should update documento" do
    patch documento_url(@documento), params: { documento: { contenido: @documento.contenido, descripcion: @documento.descripcion } }
